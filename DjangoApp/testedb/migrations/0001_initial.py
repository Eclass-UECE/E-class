    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('foto_frente', models.FileField(upload_to='uploads/<django.db.models.fields.CharField>/', verbose_name='Foto da identidade (Frente)')),
                ('foto_verso', models.FileField(upload_to='uploads/<django.db.models.fields.CharField>/', verbose_name='Foto da identidade (Verso)')),
                ('diploma_ensino_medio', models.FileField(upload_to='uploads/<django.db.models.fields.CharField>/', verbose_name='Foto do diploma do ensino médio')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('inscricao', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='testedb.inscricao')),
            ],
            options={
